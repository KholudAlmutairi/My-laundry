...
public class ProfileService {
    ...
    public void addProfiler(ProfileDTO profileDTO){
        Customer customer=customerRepository.findCustomersById(profileDTO.getCustomerId());
        if(customer==null){
    ...
    public void updateProfile(ProfileDTO profileDTO) {
        Profile profile=profileRepository.findProfileById(profileDTO.getCustomerId());
